...
# Параметры
BUNDLE_ID="com.abstractmoves.cube"
APPLE_ID="6756566822"
REMOTE_URL="git@github.com:sdeslvm/Abstraction-Cube-Moves.git"
PROJECT_NAME="Abstraction Cube Moves"
SCHEME_NAME="Abstraction Cube Moves"
