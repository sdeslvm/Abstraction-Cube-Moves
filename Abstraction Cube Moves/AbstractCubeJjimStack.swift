...
enum AbstractCubeWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: AbstractCubeWebStatus) -> Bool {
        switch (self, other) {
...
extension AbstractCubeWebStatus {
...
extension AbstractCubeWebStatus {
    static func == (lhs: AbstractCubeWebStatus, rhs: AbstractCubeWebStatus) -> Bool {
