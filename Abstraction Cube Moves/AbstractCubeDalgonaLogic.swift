...
final class AbstractCubeOrientationManager {
    static let shared = AbstractCubeOrientationManager()
...
final class AbstractCubeAppDelegate: NSObject, UIApplicationDelegate {
    func application(
