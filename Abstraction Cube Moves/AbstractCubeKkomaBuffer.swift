...
class AbstractCubeWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (AbstractCubeWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (AbstractCubeWebStatus) -> Void) {
