...
protocol WebLoadable: AnyObject {
    var state: AbstractCubeWebStatus { get set }
...
final class AbstractCubeWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

    @Published var state: AbstractCubeWebStatus = .standby
    ...
    func observeProgression() {
        progressPublisher
            ...
            .sink { [weak self] progress in
                ...
                let newState: AbstractCubeWebStatus = progress < 1.0 ? .progressing(progress: progress) : .finished
...
extension AbstractCubeWebLoader: WKNavigationDelegate {
...
extension AbstractCubeWebLoader {
    ...
    func publish(_ newState: AbstractCubeWebStatus) {
...
private extension AbstractCubeWebLoader {
    func updateState(_ newState: AbstractCubeWebStatus) {
