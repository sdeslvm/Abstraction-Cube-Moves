...
final class AbstractCubeBaseWebViewController: UIViewController, WKScriptMessageHandler {
    ...
    private let loader: AbstractCubeWebLoader
    private let coordinator: AbstractCubeWebCoordinator
    ...
    init(
        ...
        loader: AbstractCubeWebLoader,
        coordinator: AbstractCubeWebCoordinator,
    ...
    override func viewDidLoad() {
        ...
        AbstractCubeOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
    ...
    override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
        AbstractCubeOrientationManager.shared.currentMask
    }
    ...
    private func unlockOrientationIfNeeded() {
        ...
        AbstractCubeOrientationManager.shared.updateAllowedOrientations(.all)
    }
...
private extension AbstractCubeBaseWebViewController {
